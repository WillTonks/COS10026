...
Please note that for assignment 2 some maxlength label inputs were changed so the php could validate it instead
-->
<html lang="en">
<head>
	<meta charset="utf-8"/>
...
<!--The main part of the form. the form is divided into sections which then contain the inputs.
	...
	<fieldset>
		...
		<p><label for="reference_number"> Job reference number </label><br>
			<input type="text" name="reference_number" id="reference_number" maxlength="10" size="10" pattern=".{5}" title="Exactly 5 characters" placeholder="5 characters" required="required"/>
		</p>
		<p><label for="firstName"> Given name: </label><br>
			<input type="text" name="first_name" id="first_name" maxlength="25" size="20" pattern="^[a-zA-Z]+$" title="Enter given name" placeholder="Enter given name" required="required"/><br>
		    <label for="familyName">Family name: </label><br>
			<input type="text" name="family_name" id="family_name" maxlength="25" size="20" pattern="^[a-zA-Z]+$" title="Enter family name" placeholder="Enter family name" required="required"/>
		</p>
	</fieldset>
	<fieldset>
	...
	<fieldset>
		...
		<p><label for="address"> Street Address </label>
			<input type="text" name="address" id="address" maxlength="45" size="18" title="Enter the address of where you live" placeholder="00 StreetName Road" required="required"/>
		</p>
		<p><label for="suburb"> Suburb/town </label>
			<input type="text" name="suburb" id="suburb" maxlength="45" size="18" title="Enter the suburb or town of where you live" placeholder="Suburb/Town" required="required"/>
		</p>
		...
		<p><label for="postcode"> Postcode </label>
			<input type="text" name="postcode" id="postcode" maxlength="8" size="10" pattern="[0-9]{4}" title="Exactly 4 numbers" placeholder="0000" required="required"/>
		</p>
	</fieldset>
	<fieldset>
		...
		<p><label for="phone"> Phone number </label>
			<input type="text" name="phone" id="phone" maxlength="18" size="12" pattern="^[0-9]{8,12}+$"title="8 to 12 digits/spaces" placeholder="8-12 digits/spaces" required="required"/>
		</p>
	</fieldset>
	<fieldset>
